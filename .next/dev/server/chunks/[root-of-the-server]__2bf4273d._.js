...
"[project]/app/api/youtube/resolve/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (data.videos?.items) {
            const best = data.videos.items.find((v)=>v.quality === '720p' && v.extension === 'mp4') || data.videos.items.find((v)=>v.extension === 'mp4');
            directUrl = best?.url || '';
        }
        if (!directUrl) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No se encontró link MP4'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2bf4273d._.js.map